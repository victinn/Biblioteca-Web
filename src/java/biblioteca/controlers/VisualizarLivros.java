 ...
 * @author victo
 */
@WebServlet(name = "VisualizarLivros", urlPatterns = {"/VisualizarLivros"})
public class VisualizarLivros extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("livros", modelL.getlivros());
